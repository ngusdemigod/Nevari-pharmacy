...
final class Nevari_Activator {
    ...
    private static function create_tables(): void {
        ...
        dbDelta("CREATE TABLE {$appointments} (
            ...
            customer_reminder_2h_sent_at DATETIME NULL,
            customer_reminder_30m_sent_at DATETIME NULL,
            customer_reminder_5m_sent_at DATETIME NULL,
            customer_appointment_start_sent_at DATETIME NULL,
            doctor_reminder_24h_sent_at DATETIME NULL,
            doctor_reminder_1h_sent_at DATETIME NULL,
            doctor_reminder_2h_sent_at DATETIME NULL,
            doctor_reminder_30m_sent_at DATETIME NULL,
            doctor_reminder_5m_sent_at DATETIME NULL,
            doctor_appointment_start_sent_at DATETIME NULL,
            customer_ending_soon_sent_at DATETIME NULL,
            doctor_ending_soon_sent_at DATETIME NULL,
            customer_followup_sent_at DATETIME NULL,
            patient_waiting_notify_count INT UNSIGNED NOT NULL DEFAULT 0,
            patient_waiting_notify_last_at DATETIME NULL,
            doctor_waiting_notify_count INT UNSIGNED NOT NULL DEFAULT 0,
            doctor_waiting_notify_last_at DATETIME NULL,
            ...
            KEY customer_reminder_2h_sent_at (customer_reminder_2h_sent_at),
            KEY customer_reminder_30m_sent_at (customer_reminder_30m_sent_at),
            KEY customer_reminder_5m_sent_at (customer_reminder_5m_sent_at),
            KEY customer_appointment_start_sent_at (customer_appointment_start_sent_at),
            KEY doctor_reminder_24h_sent_at (doctor_reminder_24h_sent_at),
            KEY doctor_reminder_1h_sent_at (doctor_reminder_1h_sent_at),
            KEY doctor_reminder_2h_sent_at (doctor_reminder_2h_sent_at),
            KEY doctor_reminder_30m_sent_at (doctor_reminder_30m_sent_at),
            KEY doctor_reminder_5m_sent_at (doctor_reminder_5m_sent_at),
            KEY doctor_appointment_start_sent_at (doctor_appointment_start_sent_at),
            KEY customer_ending_soon_sent_at (customer_ending_soon_sent_at),
            KEY doctor_ending_soon_sent_at (doctor_ending_soon_sent_at),
        ...
        dbDelta("CREATE TABLE {$mtm_requests} (
            ...
            request_reference VARCHAR(32) NULL,
            ...
            submission_pdf_status VARCHAR(20) NOT NULL DEFAULT 'pending',
            submission_pdf_path VARCHAR(500) NULL,
            submission_pdf_hash CHAR(64) NULL,
            submission_pdf_size BIGINT UNSIGNED NOT NULL DEFAULT 0,
            submission_pdf_mime VARCHAR(100) NULL,
            submission_pdf_version VARCHAR(32) NULL,
            submission_pdf_created_at DATETIME NULL,
            ...
            google_meet_created_at DATETIME NULL,
            google_meet_ended_at DATETIME NULL,
            customer_join_token_hash VARCHAR(64) NULL,
            pharmacist_join_token_hash VARCHAR(64) NULL,
            join_valid_from_at DATETIME NULL,
            join_expires_at DATETIME NULL,
            customer_checked_in_at DATETIME NULL,
            pharmacist_checked_in_at DATETIME NULL,
            missed_attendance_at DATETIME NULL,
            missed_attendance_role VARCHAR(20) NULL,
            ...
            KEY customer_join_token_hash (customer_join_token_hash),
            KEY pharmacist_join_token_hash (pharmacist_join_token_hash),
            KEY order_id (order_id),
    ...
    private static function seed_defaults(): void {
        ...
        $templates = [
            [
                ...
                'body_html' => '<p>Hello {{patient_name}},</p><p>Your appointment with {{doctor_name}} is pending payment.</p><p>Your appointment has been created for {{appointment_date}} at {{appointment_time}}.</p><p><strong>Duration:</strong> {{appointment_duration}}<br /><strong>Reference:</strong> {{appointment_reference}}<br /><strong>Invoice:</strong> {{invoice_number}}</p><p>This booking expires after 5 minutes if payment is not completed.</p><p>{{payment_link_html}}</p><p>You can also view this booking inside your Nevari dashboard.</p>',
