...
const OUTPUT_PATH = path.join(process.cwd(), 'temp', 'playwright_subscription_prod_verify.json');
...
(async () => {
  ...
  try {
    ...
    const result = {
      ...
      missingDetailsMessageVisible: await page.locator('text=Paystack cancellation details are missing').count(),
    };
