...
final class Commerce_Renderer {
    ...
    public static function cart_defaults() {
        return array(
            ...
            'show_image' => 'yes', 'show_regular_price' => 'yes', 'show_remove_icon' => 'yes', 'show_remove_text' => 'yes',
    ...
    public static function order_defaults() {
        return array(
            'show_back' => 'yes', 'back_label' => __('Back', 'nevari-checkout'), 'back_url' => wc_get_page_permalink('shop'),
            'heading' => __('Order in Progress', 'nevari-checkout'), 'heading_tag' => 'h1', 'success_title' => __('Order is Placed', 'nevari-checkout'),
