...
final class Checkout_Service {
    ...
    public function checkout_fields($fields) {
        foreach (array('billing_phone', 'billing_city', 'billing_state', 'billing_postcode', 'billing_country') as $key) {
            if (isset($fields['billing'][$key])) {
                $fields['billing'][$key]['required'] = false;
            }
        }
        foreach (array('shipping_city', 'shipping_state', 'shipping_postcode', 'shipping_country') as $key) {
