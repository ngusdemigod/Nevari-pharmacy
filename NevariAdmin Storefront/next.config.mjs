...
export default withSentryConfig(nextConfig, {
  ...
  org: process.env.SENTRY_ORG || "silvera-4z",
  project: process.env.SENTRY_PROJECT || "nevari-webapp",
  authToken: hasSentryUploadCredentials ? process.env.SENTRY_AUTH_TOKEN : undefined,
