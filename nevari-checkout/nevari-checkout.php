...
add_action('init', function () {
    ...
    $module_file = __DIR__ . '/includes/elementor/class-commerce-module.php';
    if (!is_readable($module_file)) { return; }
    require_once $module_file;
    if (!class_exists('Nevari\\Checkout\\Elementor\\Commerce_Module')) { return; }
